...
import com.example.MyBlog.dao.BlogConfigMapper;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String yourEmail = "2658343834@qq.com";
    public static final String yourName = "吴潇晗";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "浙ICP备 xxxxxx-x号";
    public static final String footerCopyRight = "@2021 吴潇晗";
